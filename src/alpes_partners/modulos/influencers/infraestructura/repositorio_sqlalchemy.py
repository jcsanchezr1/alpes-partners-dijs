...
class RepositorioInfluencersSQLAlchemy(RepositorioInfluencers):
    ...
    def actualizar(self, entidad: Influencer) -> None:
        ...
        if modelo:
            ...
            logger.warning(f"⚠️ REPOSITORIO: Influencer no encontrado para actualizar: {entidad.id}")
    ...
    def eliminar(self, id: str) -> None:
        ...
        if modelo:
            ...
            logger.warning(f"⚠️ REPOSITORIO: Influencer no encontrado para eliminar: {id}")
